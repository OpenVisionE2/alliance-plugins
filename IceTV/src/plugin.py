...
def _logResponseException(logger, heading, exception):
    ...
    if isinstance(exception, requests.exceptions.ConnectionError):
        msg += ": " + _("The IceTV server can not be reached. Try checking the Internet connection on your receiver\nDetails")
    msg += ": " + str(exception)
...
<screen name="IceTVLogin" position="center,50" size="990,650" title="IceTV - Login" >
    ...
    def doLogin(self):
        ...
        try:
            ...
            if not self.success:
                return
            self["instructions"].setText(_("Congratulations, you have successfully configured your receiver "
